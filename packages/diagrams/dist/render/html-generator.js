...
const svg_layout_engine_1 = require("./svg-layout-engine");
class HTMLGenerator {
    constructor(options = {}) {
        this.options = options;
        this.layoutEngine = new svg_layout_engine_1.SVGLayoutEngine(options);
    }
    generateHTML(rules, filename) {
        const htmlParts = [];
    ...
    generateHeader(title = 'Railroad Diagram') {
        return `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    generateRuleHTML(rule, allRules) {
